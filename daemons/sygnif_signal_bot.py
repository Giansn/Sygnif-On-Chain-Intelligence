#!/usr/bin/env python3
"""
sygnif_signal_bot.py — REFERENCE BLUEPRINT ONLY, NOT PRODUCTION.

This file is a worked example showing how to consume the
`weighted_signals` table produced by sygnif_aggregator.py. It logs
simulated entries/exits via print() and has NO exchange wiring.

Do not deploy this as a systemd service against a real account. The
actual SYGNIF executor is sygnif-trader.service on EC2; see the main
SYGNIF repository for the production execution stack.
"""
